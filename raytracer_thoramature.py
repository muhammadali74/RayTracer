...
newobjects = [Sphere(np.array([random.uniform(-0.3, 0.7), random.uniform(0, 0.8), random.uniform(0, -3)]), random.uniform(0, 0.2), np.array([0.1, 0.1, 0.1]),
                     np.array([random.uniform(0, 0.6), random.uniform(0, 0.6), random.uniform(0, 0.6)]), np.array([1, 1, 1]), 100, random.uniform(0, 0.5)) for k in range(200)]
...
for l in range(1):
    ...
    cam = Camera(1, 300/200,   np.array([18/10,18/10,1]), np.array([0,0,-1]), np.array([0,1,0]))
    image = np.zeros((height, width, 3))
    tree.remove(objects[4])
    tree.insert(Sphere(np.array([-0.3, 0.4, -2]), 0.6, np.array([0.4, 0.1, 0.1]),
           np.array([0.1, 0.6, 0.4]), np.array([1, 1, 1]), 100, 0.5))
    # plt.show()
    start = time.time()
    ...
    plt.imsave('image'+str(17)+'.png', image)
