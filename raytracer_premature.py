...
#      'diffuse': np.array([0.6, 0.6, 0.6]), 'specular': np.array([1, 1, 1]), 'shininess': 100, 'reflection': 0.5, 'color': np.array([1, 1, 1])}
# ]
...
objects = [
    ...
    {'center': np.array([-0.5, 0.5, -0.5]), 'radius': 0.15, 'ambient': np.array([0, 0.1, 0.6]), 'diffuse': np.array(
        [0, 0.6, 0]), 'specular': np.array([1, 1, 1]), 'shininess': 100, 'reflection': 0.5},
    {'center': np.array([-0.3, 0.4, -2]), 'radius': 0.9, 'ambient': np.array([0.2, 0.1, 0]), 'diffuse': np.array(
        [0, 0.6, 0]), 'specular': np.array([1, 1, 1]), 'shininess': 100, 'reflection': 0.5},
    {'center': np.array([0, -9000, 0]), 'radius': 9000 - 0.7, 'ambient': np.array([0.1, 0.1, 0.1]),
